$(function () {
    var banner_list = $(".top_banner"),set_intevBanner,
    banner_list_li = banner_list.children("div");
    ...
    top_banner_setInterval();
    banner_list_li.each(function (i) {
        var that = $(this);
    ...
    function top_banner_setInterval() {
        set_intevBanner = setInterval(function () {
            var _list_active = banner_list.children("div.active"),
                _next_list_li = _list_active.next("div");
            if (_next_list_li.length <= 0) {
                _next_list_li = banner_list.children("div").eq(0);
            }
    ...
    function sidebar(){
        ...
        $('.sideGoodCategoriesMenu .list li').mouseover(function (){
            ...
            if($($('.sideGoodCategoriesDetail .item .listWrap .list')[index]).children().length!=0){
    ...
    function flushCartItemCount(){
        $.get("/"+hd_appId + "/serverHandler/getCountInCart.jsx",{t:Math.random()},function(data){
            ...
            $(".numCar").html(Number(totalNumber) > 99 ? "99+" : totalNumber+"");
